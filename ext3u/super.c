...
static struct file_system_type ext3u_fs_type = {
	.owner		= THIS_MODULE,
	.name		= "ext3u",
	.get_sb		= ext3_get_sb,
...
static int __init init_ext3_fs(void)
{
	...
	if (err)
		goto out1;
        err = register_filesystem(&ext3u_fs_type);
	if (err)
		goto out;
...
{
	unregister_filesystem(&ext3u_fs_type);
	destroy_inodecache();
	exit_ext3_xattr();
}

MODULE_AUTHOR("Remy Card, Stephen Tweedie, Andrew Morton, Andreas Dilger, Theodore Ts'o and others");
MODULE_DESCRIPTION("Second Extended Filesystem with journaling extension and undelete capabilities");
MODULE_LICENSE("GPL");
